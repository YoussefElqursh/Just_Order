...
class _RestaurantScreenState extends State<RestaurantScreen> {
  ...
  Future<void> _checkIfFavorite() async {
    ...
    try {
      ...
      debugPrint(
        "Time take to check favourite is : " +
            DateTime.now().difference(checkFavourite).inMilliseconds.toString(),
      );
    } catch (e) {
  ...
  Future<void> _loadItems() async {
    ...
    final fetchItems = await userRepository.getItems(
